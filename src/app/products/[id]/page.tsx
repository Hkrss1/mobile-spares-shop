...
export default async function ProductPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="container animate-fade-in" style={{ padding: '4rem 1rem' }}>
            <Link href="/" style={{ display: 'inline-flex', alignItems: 'center', marginBottom: '2rem', color: 'hsl(var(--muted-foreground))', fontSize: '0.875rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem' }}>
                ...
                <div>
                    ...
                    <p style={{ fontSize: '1.125rem', color: 'hsl(var(--muted-foreground))', lineHeight: 1.6, marginBottom: '2.5rem' }}>
                        {product.description}
                    </p>
