...
export default function ForgotPasswordPage() {
  ...
  return (
    <div
      ...
      style={{ padding: "4rem 1rem", maxWidth: "450px", margin: "0 auto" }}
    >
      <div
        style={{
      ...
      >
          ...
          <div>
            ...
            >
              ...
              <p style={{ fontSize: "0.875rem" }}>
                Check your WhatsApp for password reset instructions sent to +91
                {mobile}
              </p>
            </div>
        ...
        >
          ...
          <br />
          3. WhatsApp will open with your password
          <br />
