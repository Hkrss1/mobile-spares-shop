...
const products = [
  {
    ...
    description:
      "High-quality OLED replacement screen for iPhone 13 Pro. Supports 120Hz ProMotion and True Tone.",
    specs: {
  ...
  },
  {
    ...
    description:
      "Original capacity replacement battery for Samsung Galaxy S21. Fixes fast draining issues.",
    specs: {
  ...
  },
  {
    ...
    description:
      "Replacement USB-C charging port flex cable for Google Pixel 6. Solves charging and data transfer problems.",
    specs: {
  ...
  },
  {
    ...
    description:
      "OEM quality back glass replacement for OnePlus 9. Includes pre-installed adhesive.",
    specs: {
  ...
  },
  {
    ...
    description:
      "Rear main camera module replacement for iPhone 12 Mini. Restores focus and image quality.",
    specs: {
  ...
  },
  {
    ...
    description:
      "Loudspeaker module replacement for Xiaomi Mi 11. Fixes distorted or no sound issues.",
    specs: {
